...
**Critère d'acceptation :** `Scénario 1`, `AC-1`, `Contrainte C-16`, `REQ-103`  
**Type :** acceptation / sécurité  
**Niveau de risque :** critique

## Ce que ce cas protège

Ce cas protège l'authentification sécurisée de l'unique profil administrateur de Ti'Baleine sur poste de travail Desktop. Si la règle se casse, l'administrateur ne peut plus accéder au système de gestion ou un tiers non autorisé pourrait forcer l'accès.
...
- [ ] Le test soumet des identifiants d'administration valides.
