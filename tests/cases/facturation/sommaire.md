...
|---|---|---|---|
| 700 | CASE-FAC-700.md | Envoi de la facture PDF acquittée après paiement d'une réservation individuelle à Saint-Leu (Baleines 2 adultes 150 €) | `Scénario 1`, `AC-1`, `AC-2`, `AC-3`, `AC-5` |
| 701 | CASE-FAC-701.md | Envoi de la facture PDF acquittée après paiement d'une privatisation standard (forfait demi-journée matin 600 €) | `Scénario 2`, `AC-1`, `AC-2`, `AC-3`, `AC-5` |
...
| 706 | CASE-FAC-706.md | Facturation d'une privatisation forfaitaire au départ de Saint-Leu sans application de majoration géographique | `AC-1`, `AC-2`, `Scénario 2`, `Cas limite #5` |
...
| 716 | CASE-FAC-716.md | Inclusion du récapitulatif de la réservation dans le corps du courriel transactionnel | `AC-5`, `Scénario 1` |
...
| 718 | CASE-FAC-718.md | Traitement d'un échec d'envoi SMTP : passage à l'état « échec d'émission » et horodatage en base | `AC-3`, `AC-4`, `Cas limite #1` |
