...
TA TÂCHE
Écris UN test automatisé, et un seul, qui traduit CASE-RES-401.
...
6. Ne modifie aucun fichier en dehors de :
   - tests/tests-unitaires/reservation/CASE-RES-401.test.ts
   - tests/cases/reservation/CASE-RES-401.md (uniquement le champ « Fichier »)
