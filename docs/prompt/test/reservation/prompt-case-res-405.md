# Prompt — écrire la fiche de cas CASE-RES-405
...
> `docs/prompt/code/reservation/prompt-case-res-405.md`, qui fait
> écrire le test.
>
...
TA TÂCHE
Écris UNE fiche de cas, et une seule : tests/cases/reservation/CASE-RES-405.md
...
2. En-tête imposé : Spécification `SPEC-RESERVATION-03` ; Critère
   d'acceptation `AC-4` ; Type acceptation ; Niveau de risque moyen.
...
8. La checklist « Revue du test automatisé » se termine obligatoirement par
   ...
   `CASE_RES_405` », et « Aucune assertion étrangère à ce cas n'a été
   ajoutée ».
...
10. Ne modifie aucun fichier en dehors de :
    tests/cases/reservation/CASE-RES-405.md
