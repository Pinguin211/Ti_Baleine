...
TA TÂCHE
Écris UN test automatisé, et un seul, qui traduit CASE-RES-408.
...
6. Ne modifie aucun fichier en dehors de :
   - tests/tests-unitaires/reservation/CASE-RES-408.test.ts
   - tests/cases/reservation/CASE-RES-408.md (uniquement le champ « Fichier »)
