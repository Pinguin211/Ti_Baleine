...
Emplacement des tests : tests/tests-unitaires/reservation/
...
TA TÂCHE
Écris UN test automatisé, et un seul, qui traduit CASE-RES-420.
...
6. Ne modifie aucun fichier en dehors de :
   - tests/tests-unitaires/reservation/CASE-RES-420.test.ts
   - tests/cases/reservation/CASE-RES-420.md (uniquement le champ « Fichier »)
