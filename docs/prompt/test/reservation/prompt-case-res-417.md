# Prompt — écrire la fiche de cas CASE-RES-417
...
> `docs/prompt/code/reservation/prompt-case-res-417.md`, qui fait
> écrire le test.
>
...
- Hypothèse non validée applicable à ce cas : la durée du verrou (10 minutes)
  est un choix déduit, posé en question ouverte n°12 §11 du CDC v4. La fiche
  doit le signaler explicitement en tête et isoler cette durée comme une donnée
  ajustable (voir specs/reservation.md, § « Ce qui n'est pas défini »).

TA TÂCHE
Écris UNE fiche de cas, et une seule : tests/cases/reservation/CASE-RES-417.md
...
2. En-tête imposé : Spécification `SPEC-RESERVATION-03` ; Critère
   d'acceptation `AC-2, AC-8` ; Type acceptation ; Niveau de risque élevé.
...
8. La checklist « Revue du test automatisé » se termine obligatoirement par
   ...
   `CASE_RES_417` », et « Aucune assertion étrangère à ce cas n'a été
   ajoutée ».
...
10. Ne modifie aucun fichier en dehors de :
    tests/cases/reservation/CASE-RES-417.md
