...
TA TÂCHE
Écris UN test automatisé, et un seul, qui traduit CASE-FAC-707.
...
6. Ne modifie aucun fichier en dehors de :
   - tests/tests-unitaires/facturation/CASE-FAC-707.test.ts
   - tests/cases/facturation/CASE-FAC-707.md (uniquement le champ « Fichier »)
