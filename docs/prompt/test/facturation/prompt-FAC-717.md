...
TA TÂCHE
Écris UN test automatisé, et un seul, qui traduit CASE-FAC-717.
...
6. Ne modifie aucun fichier en dehors de :
   - tests/tests-unitaires/facturation/CASE-FAC-717.test.ts
   - tests/cases/facturation/CASE-FAC-717.md (uniquement le champ « Fichier »)
