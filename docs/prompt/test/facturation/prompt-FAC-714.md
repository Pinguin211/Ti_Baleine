...
TA TÂCHE
Écris UN test automatisé, et un seul, qui traduit CASE-FAC-714.
...
6. Ne modifie aucun fichier en dehors de :
   - tests/tests-unitaires/facturation/CASE-FAC-714.test.ts
   - tests/cases/facturation/CASE-FAC-714.md (uniquement le champ « Fichier »)
