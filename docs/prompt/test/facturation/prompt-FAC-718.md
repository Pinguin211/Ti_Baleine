...
TA TÂCHE
Écris UN test automatisé, et un seul, qui traduit CASE-FAC-718.
...
6. Ne modifie aucun fichier en dehors de :
   - tests/tests-unitaires/facturation/CASE-FAC-718.test.ts
   - tests/cases/facturation/CASE-FAC-718.md (uniquement le champ « Fichier »)
