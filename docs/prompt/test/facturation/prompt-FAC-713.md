...
TA TÂCHE
Écris UN test automatisé, et un seul, qui traduit CASE-FAC-713.
...
6. Ne modifie aucun fichier en dehors de :
   - tests/tests-unitaires/facturation/CASE-FAC-713.test.ts
   - tests/cases/facturation/CASE-FAC-713.md (uniquement le champ « Fichier »)
