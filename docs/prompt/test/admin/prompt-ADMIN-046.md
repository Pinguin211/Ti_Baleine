# Prompt — écrire le test de CASE-ADMIN-046
...
>
> Prérequis : le cas `tests/cases/admin/CASE-ADMIN-046.md` doit exister.
>
...
- La spécification métier : specs/admin.md, section SPEC-ADMIN-05
