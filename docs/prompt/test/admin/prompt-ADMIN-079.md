# Prompt — écrire le test de CASE-ADMIN-079
...
>
> Prérequis : le cas `tests/cases/admin/CASE-ADMIN-079.md` doit exister.
>
...
- La spécification métier : specs/admin.md, section SPEC-ADMIN-02
- Les exigences d'architecture : specs/architecture.md (règles SPEC-ARCH-01 et SPEC-ARCH-02)

TA TÂCHE
Écris UN test automatisé, et un seul, qui traduit CASE-ADMIN-079.
...
6. Ne modifie aucun fichier en dehors de :
   ...
   - tests/cases/admin/CASE-ADMIN-079.md (uniquement le champ « Fichier »)
