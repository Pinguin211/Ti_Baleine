# Prompt — écrire le test de CASE-ADMIN-035
...
>
> Prérequis : le cas `tests/cases/admin/CASE-ADMIN-035.md` doit exister.
>
...
- La spécification métier : specs/admin.md, section SPEC-ADMIN-04
