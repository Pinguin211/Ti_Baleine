# Prompt — écrire le test de CASE-ADMIN-077
...
>
> Prérequis : le cas `tests/cases/admin/CASE-ADMIN-077.md` doit exister.
>
...
TA TÂCHE
Écris UN test automatisé, et un seul, qui traduit CASE-ADMIN-077.
...
6. Ne modifie aucun fichier en dehors de :
   ...
   - tests/cases/admin/CASE-ADMIN-077.md (uniquement le champ « Fichier »)
