# Prompt — écrire le test de CASE-ADMIN-067
...
>
> Prérequis : le cas `tests/cases/admin/CASE-ADMIN-067.md` doit exister.
>
...
- La spécification métier : specs/admin.md, section SPEC-ADMIN-07
