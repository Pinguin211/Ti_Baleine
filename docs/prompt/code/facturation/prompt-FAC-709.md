...
Commande pour ce seul test : npx vitest run tests/tests-unitaires/facturation/CASE-FAC-709.test.ts -t "test_CASE_FAC_709_presence_date_et_creneau_horaire_sur_factures_acompte_et_solde"
Commande d'audit d'architecture : npm run arch:report

CE QUE JE TE DONNE
- Le test à faire passer : tests/tests-unitaires/facturation/CASE-FAC-709.test.ts::test_CASE_FAC_709_presence_date_et_creneau_horaire_sur_factures_acompte_et_solde
- Le cas de test : tests/cases/facturation/CASE-FAC-709.md
...
TA TÂCHE
1. Fais passer au vert le test test_CASE_FAC_709_presence_date_et_creneau_horaire_sur_factures_acompte_et_solde, et lui seul.
...
4. La règle vit dans le domaine : src/utils/formatage-date-facturation.util.ts.
