...
Commande pour ce seul test : npx vitest run tests/tests-unitaires/facturation/CASE-FAC-702.test.ts -t "test_CASE_FAC_702_facturation_acompte_reservation_standard_saint_gilles_sans_supplement"
Commande d'audit d'architecture : npm run arch:report

CE QUE JE TE DONNE
- Le test à faire passer : tests/tests-unitaires/facturation/CASE-FAC-702.test.ts::test_CASE_FAC_702_facturation_acompte_reservation_standard_saint_gilles_sans_supplement
- Le cas de test : tests/cases/facturation/CASE-FAC-702.md
...
- Les couches du domaine que tu peux modifier : src/utils/

TA TÂCHE
1. Fais passer au vert le test test_CASE_FAC_702_facturation_acompte_reservation_standard_saint_gilles_sans_supplement, et lui seul.
...
4. La règle vit dans le domaine : src/utils/calcul-tarification-facturation.util.ts (absence de majoration géographique au départ de Saint-Gilles).
...
7. Ne modifie aucun fichier en dehors de : src/utils/
