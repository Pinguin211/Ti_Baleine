...
Commande pour ce seul test : npx vitest run tests/tests-unitaires/facturation/CASE-FAC-707.test.ts -t "test_CASE_FAC_707_presence_obligatoire_et_unicite_identifiants_facture_acompte_solde"
Commande d'audit d'architecture : npm run arch:report

CE QUE JE TE DONNE
- Le test à faire passer : tests/tests-unitaires/facturation/CASE-FAC-707.test.ts::test_CASE_FAC_707_presence_obligatoire_et_unicite_identifiants_facture_acompte_solde
- Le cas de test : tests/cases/facturation/CASE-FAC-707.md
- La spécification : specs/facturation.md, section SPEC-FAC-02 (AC-1, AC-2, Scénario 1, Portée §1)
...
TA TÂCHE
1. Fais passer au vert le test test_CASE_FAC_707_presence_obligatoire_et_unicite_identifiants_facture_acompte_solde, et lui seul.
...
4. La règle vit dans le domaine : src/utils/generation-identifiant-facture.util.ts.
