...
Commande pour ce seul test : npx vitest run tests/tests-unitaires/facturation/CASE-FAC-714.test.ts -t "test_CASE_FAC_714_expedition_immediate_courriel_transactionnel_adresse_client_acompte_et_solde"
Commande d'audit d'architecture : npm run arch:report

CE QUE JE TE DONNE
- Le test à faire passer : tests/tests-unitaires/facturation/CASE-FAC-714.test.ts::test_CASE_FAC_714_expedition_immediate_courriel_transactionnel_adresse_client_acompte_et_solde
- Le cas de test : tests/cases/facturation/CASE-FAC-714.md
- La spécification : specs/facturation.md, section SPEC-FAC-02 (AC-6, Règle)
...
TA TÂCHE
1. Fais passer au vert le test test_CASE_FAC_714_expedition_immediate_courriel_transactionnel_adresse_client_acompte_et_solde, et lui seul.
...
4. La règle vit dans le domaine : src/services/server/envoyer-courriel-facture.service.ts.
