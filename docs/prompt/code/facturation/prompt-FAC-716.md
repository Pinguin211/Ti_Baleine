...
Commande pour ce seul test : npx vitest run tests/tests-unitaires/facturation/CASE-FAC-716.test.ts -t "test_CASE_FAC_716_inclusion_recapitulatif_reservation_corps_courriel"
Commande d'audit d'architecture : npm run arch:report

CE QUE JE TE DONNE
- Le test à faire passer : tests/tests-unitaires/facturation/CASE-FAC-716.test.ts::test_CASE_FAC_716_inclusion_recapitulatif_reservation_corps_courriel
- Le cas de test : tests/cases/facturation/CASE-FAC-716.md
- La spécification : specs/facturation.md, section SPEC-FAC-02 (AC-6, Scénario 1)
...
TA TÂCHE
1. Fais passer au vert le test test_CASE_FAC_716_inclusion_recapitulatif_reservation_corps_courriel, et lui seul.
