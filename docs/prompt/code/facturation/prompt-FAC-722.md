...
Commande pour ce seul test : npx vitest run tests/tests-unitaires/facturation/CASE-FAC-722.test.ts -t "test_CASE_FAC_722_non_declenchement_facturation_statut_paiement_en_attente_acompte_ou_solde"
Commande d'audit d'architecture : npm run arch:report

CE QUE JE TE DONNE
- Le test à faire passer : tests/tests-unitaires/facturation/CASE-FAC-722.test.ts::test_CASE_FAC_722_non_declenchement_facturation_statut_paiement_en_attente_acompte_ou_solde
- Le cas de test : tests/cases/facturation/CASE-FAC-722.md
- La spécification : specs/facturation.md, section SPEC-FAC-02 (AC-7)
...
TA TÂCHE
1. Fais passer au vert le test test_CASE_FAC_722_non_declenchement_facturation_statut_paiement_en_attente_acompte_ou_solde, et lui seul.
