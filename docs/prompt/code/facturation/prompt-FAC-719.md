...
Commande pour ce seul test : npx vitest run tests/tests-unitaires/facturation/CASE-FAC-719.test.ts -t "test_CASE_FAC_719_rebond_email_boite_pleine_absence_boucle_rattrapage_automatique"
Commande d'audit d'architecture : npm run arch:report

CE QUE JE TE DONNE
- Le test à faire passer : tests/tests-unitaires/facturation/CASE-FAC-719.test.ts::test_CASE_FAC_719_rebond_email_boite_pleine_absence_boucle_rattrapage_automatique
- Le cas de test : tests/cases/facturation/CASE-FAC-719.md
- La spécification : specs/facturation.md, section SPEC-FAC-02 (Cas limite #2, Ce qui n'est pas défini §1)
...
TA TÂCHE
1. Fais passer au vert le test test_CASE_FAC_719_rebond_email_boite_pleine_absence_boucle_rattrapage_automatique, et lui seul.
