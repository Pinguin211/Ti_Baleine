...
Commande pour ce seul test : npx vitest run tests/tests-unitaires/facturation/CASE-FAC-715.test.ts -t "test_CASE_FAC_715_piece_jointe_pdf_facture_valide"
Commande d'audit d'architecture : npm run arch:report

CE QUE JE TE DONNE
- Le test à faire passer : tests/tests-unitaires/facturation/CASE-FAC-715.test.ts::test_CASE_FAC_715_piece_jointe_pdf_facture_valide
- Le cas de test : tests/cases/facturation/CASE-FAC-715.md
- La spécification : specs/facturation.md, section SPEC-FAC-02 (AC-6, Portée §4)
...
TA TÂCHE
1. Fais passer au vert le test test_CASE_FAC_715_piece_jointe_pdf_facture_valide, et lui seul.
