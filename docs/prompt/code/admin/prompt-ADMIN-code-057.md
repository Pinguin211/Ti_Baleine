...
- Les fichiers du domaine que tu peux modifier : src/admin/alerts/, src/lib/sms/, src/lib/email/
...
4. La règle vit dans le domaine : src/admin/alerts/. Pas dans un contrôleur, pas dans un
...
7. Ne modifie aucun fichier en dehors de : `src/admin/alerts/`, `src/lib/sms/`, `src/lib/email/`.
