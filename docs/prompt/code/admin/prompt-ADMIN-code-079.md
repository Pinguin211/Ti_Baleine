...
- Les fichiers du domaine que tu peux modifier : src/admin/cancellation/, src/lib/sms/
...
7. Ne modifie aucun fichier en dehors de : `src/admin/cancellation/`, `src/lib/sms/`.
