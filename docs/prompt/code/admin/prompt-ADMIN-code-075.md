# Prompt — écrire le code de CASE-ADMIN-075
...
>
> Prérequis : le test `tests/tests-unitaires/admin/case-admin-075.test.ts` doit exister et être rouge.
>
...
Commande pour ce seul test : npx vitest run --project admin tests/tests-unitaires/admin/case-admin-075.test.ts
Commande d'audit d'architecture : npm run arch:report

CE QUE JE TE DONNE
- Le test à faire passer : tests/tests-unitaires/admin/case-admin-075.test.ts::test_CASE_ADMIN_075_blocage_encaissement_solde_reservation_deja_payee_completement
...
TA TÂCHE
1. Fais passer au vert le test test_CASE_ADMIN_075_blocage_encaissement_solde_reservation_deja_payee_completement, et lui seul.
