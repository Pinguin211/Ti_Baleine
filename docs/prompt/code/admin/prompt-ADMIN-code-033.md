...
- Les fichiers du domaine que tu peux modifier : src/admin/auth/
...
4. La règle vit dans le domaine : src/admin/auth/. Pas dans un contrôleur, pas dans un
...
7. Ne modifie aucun fichier en dehors de : `src/admin/auth/`.
