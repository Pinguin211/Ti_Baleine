...
Commande pour ce seul test : npx vitest run tests/tests-unitaires/reservation/CASE-RES-419.test.ts -t "test_CASE_RES_419_reservation_jour_meme_blocage_envoi_sms_solde_sur_place"
Commande d'audit d'architecture : npm run arch:report

CE QUE JE TE DONNE
- Le test à faire passer : tests/tests-unitaires/reservation/CASE-RES-419.test.ts::test_CASE_RES_419_reservation_jour_meme_blocage_envoi_sms_solde_sur_place
- Le cas de test : tests/cases/reservation/CASE-RES-419.md
- La spécification : specs/reservation.md, section SPEC-RESERVATION-03 (AC-11)
...
TA TÂCHE
1. Fais passer au vert le test test_CASE_RES_419_reservation_jour_meme_blocage_envoi_sms_solde_sur_place, et lui seul.
...
4. La règle vit dans le domaine : src/services/server/sms-notification.service.ts et src/actions/booking.actions.ts.
