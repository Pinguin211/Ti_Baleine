...
Commande pour ce seul test : npx vitest run tests/tests-unitaires/reservation/CASE-RES-415.test.ts -t "test_CASE_RES_415_rejet_formulaire_coordonnees_mobile_manquant_ou_format_invalide"
Commande d'audit d'architecture : npm run arch:report

CE QUE JE TE DONNE
- Le test à faire passer : tests/tests-unitaires/reservation/CASE-RES-415.test.ts::test_CASE_RES_415_rejet_formulaire_coordonnees_mobile_manquant_ou_format_invalide
...
TA TÂCHE
1. Fais passer au vert le test test_CASE_RES_415_rejet_formulaire_coordonnees_mobile_manquant_ou_format_invalide, et lui seul.
