...
Commande pour ce seul test : npx vitest run tests/tests-unitaires/reservation/CASE-RES-413.test.ts -t "test_CASE_RES_413_blocage_reservation_places_superieures_au_reliquat_disponible"
Commande d'audit d'architecture : npm run arch:report

CE QUE JE TE DONNE
- Le test à faire passer : tests/tests-unitaires/reservation/CASE-RES-413.test.ts::test_CASE_RES_413_blocage_reservation_places_superieures_au_reliquat_disponible
...
TA TÂCHE
1. Fais passer au vert le test test_CASE_RES_413_blocage_reservation_places_superieures_au_reliquat_disponible, et lui seul.
