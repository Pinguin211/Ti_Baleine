...
Commande pour ce seul test : npx vitest run tests/tests-unitaires/reservation/CASE-RES-414.test.ts -t "test_CASE_RES_414_reservation_derniere_place_passage_creneau_etat_complet"
Commande d'audit d'architecture : npm run arch:report

CE QUE JE TE DONNE
- Le test à faire passer : tests/tests-unitaires/reservation/CASE-RES-414.test.ts::test_CASE_RES_414_reservation_derniere_place_passage_creneau_etat_complet
- Le cas de test : tests/cases/reservation/CASE-RES-414.md
- La spécification : specs/reservation.md, section SPEC-RESERVATION-03 (AC-2, AC-8)
...
TA TÂCHE
1. Fais passer au vert le test test_CASE_RES_414_reservation_derniere_place_passage_creneau_etat_complet, et lui seul.
...
4. La règle vit dans le domaine : src/services/server/booking-capacity.service.ts.
