...
Commande pour ce seul test : npx vitest run tests/tests-unitaires/reservation/CASE-RES-408.test.ts -t "test_CASE_RES_408_cloture_automatique_reservation_moins_de_2_heures_du_depart"
Commande d'audit d'architecture : npm run arch:report

CE QUE JE TE DONNE
- Le test à faire passer : tests/tests-unitaires/reservation/CASE-RES-408.test.ts::test_CASE_RES_408_cloture_automatique_reservation_moins_de_2_heures_du_depart
- Le cas de test : tests/cases/reservation/CASE-RES-408.md
- La spécification : specs/reservation.md, section SPEC-RESERVATION-03 (AC-3)
...
TA TÂCHE
1. Fais passer au vert le test test_CASE_RES_408_cloture_automatique_reservation_moins_de_2_heures_du_depart, et lui seul.
