...
Commande pour ce seul test : npx vitest run tests/tests-unitaires/reservation/CASE-RES-400.test.ts -t "test_CASE_RES_400_reservation_individuelle_saint_gilles_acompte_payee_partiellement"
Commande d'audit d'architecture : npm run arch:report

CE QUE JE TE DONNE
- Le test à faire passer : tests/tests-unitaires/reservation/CASE-RES-400.test.ts::test_CASE_RES_400_reservation_individuelle_saint_gilles_acompte_payee_partiellement
...
TA TÂCHE
1. Fais passer au vert le test test_CASE_RES_400_reservation_individuelle_saint_gilles_acompte_payee_partiellement, et lui seul.
