...
Commande pour ce seul test : npx vitest run tests/tests-unitaires/reservation/CASE-RES-405.test.ts -t "test_CASE_RES_405_grille_tarifaire_dauphins_saint_gilles_acompte_30_pourcent"
Commande d'audit d'architecture : npm run arch:report

CE QUE JE TE DONNE
- Le test à faire passer : tests/tests-unitaires/reservation/CASE-RES-405.test.ts::test_CASE_RES_405_grille_tarifaire_dauphins_saint_gilles_acompte_30_pourcent
- Le cas de test : tests/cases/reservation/CASE-RES-405.md
- La spécification : specs/reservation.md, section SPEC-RESERVATION-03 (AC-4, AC-8)
...
TA TÂCHE
1. Fais passer au vert le test test_CASE_RES_405_grille_tarifaire_dauphins_saint_gilles_acompte_30_pourcent, et lui seul.
...
4. La règle vit dans le domaine : src/utils/pricing-calculator.ts.
